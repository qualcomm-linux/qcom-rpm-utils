# Contributing to qcom-rpm-utils
...
1. [Fork](https://github.com/qualcomm-linux/qcom-rpm-utils/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/qcom-rpm-utils.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/qcom-rpm-utils.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/qcom-rpm-utils/pulls) from your branch to `main`.
